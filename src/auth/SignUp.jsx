  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Create an account with SERA Innovations to get started on managing your projects efficiently. Sign up now to access all our digital solutions."
        />
        <meta
          name="keywords"
          content="Serainnovations, Sera Innovations, sign up, register, account creation, project management, digital solutions"
        />
        <meta property="og:title" content="Sign Up - SERA Innovations" />
        <meta
          property="og:description"
          content="Create an account with SERA Innovations to get started on managing your projects efficiently."
        />
        <meta
          property="og:image"
          content="https://serainnovations.pro/path-to-your-image.jpg"
        />
          ...
          <div className="login p-20 bg-orange-500 shadow-lg">
            ...
            <form className="flex flex-col m-5">
              ...
              <button
                ...
                type="button"
              >
                {loading ? <div className='flex justify-center items-center content-center'><img className="rounded-s-3xl w-5 h-5" src="loadinggif.gif" alt="Loading gif" /></div>:'Sign up'}
              </button>
            </form>
          </div>
          <aside className="img hidden md:block ml-56 md:ml-20">
            <img
              className="h-[500px] w-[500px] flex-wrap"
              src="/signup-now.png"
              alt="Sign up"
            />
          </aside>
