                                        ...
                                        <div className="row">
                                            <div className="offset-lg-1 col-lg-10 col-md-12 col-12">
                                                <div className="flex flex-col lg:flex-row items-center justify-between">
                                                    ...
                                                    {/* <div>
                                                        <Link to="/instructor/posts/" className="p-3 rounded-lg text-white bg-blue-500 ">
                                                            <i className="fas fa-arrow-left"></i> Back to Posts
                                                        </Link>
                                                        <a href="instructor-posts.html" className="p-3 rounded-lg text-white bg-green-500 mx-1">
